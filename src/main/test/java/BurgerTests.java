...
public class BurgerTests {
    ...
    public void setBuns() {
        ...
        assertEquals("Bun not set for burger", bun, actual);
    }
    ...
    public void addIngredient() {
        ...
        assertEquals("Ingredient not added to list", expected, actual);
    }
    ...
    public void removeIngredient() {
        ...
        assertEquals("Ingredient not removed from list", List.of(), actual);
    }
    ...
    public void moveIngredient() {
        ...
        assertEquals("Ingredient moved in the list incorrectly", filling, actual);
    }
