...
public class DataBaseTests {
    private final Bun bunWithOnion;
    ...
    public DataBaseTests(Bun bunWithOnion, Ingredient secretIngredient, IngredientType ingredientType) {
        this.bunWithOnion = bunWithOnion;
    ...
    public void setUp() {
        ...
        when(database.availableBuns()).thenReturn(Arrays.asList(bunWithOnion));
    ...
    public void testAvailableBuns() {
        ...
        Assert.assertEquals(bunWithOnion.getName(), buns.get(0).getName());
        Assert.assertEquals(bunWithOnion.getPrice(), buns.get(0).getPrice(), 0.002);
