...
public class IngredientTest {
    ...
    public static Object[][] data() {
        return new Object[][]{
                {IngredientType.SAUCE, "barbecue sauce", 150},
                {IngredientType.SAUCE, "garlic sauce", 250},
                {IngredientType.FILLING, "bacon", 120},
                {IngredientType.FILLING, "grilled chicken", 350}
        };
    }
