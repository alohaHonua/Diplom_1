...
public class IngredientTest {
    ...
    public void testGetPrice() {
        Ingredient ingredient = new Ingredient(IngredientType.BUN, "Wheat Bun", 1.2f);
        assertEquals(1.2f, ingredient.getPrice(), 0.001);
    }
    @Test
    public void testGetName() {
        Ingredient ingredient = new Ingredient(IngredientType.BUN, "Wheat Bun", 1.2f);
        assertEquals("Wheat Bun", ingredient.getName());
    }
}
