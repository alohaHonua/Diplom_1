...
public class BunTest {
    ...
    public static Object[][] testData() {
        return new Object[][]{
                ...
                //Проверка булки без названия
                {"", 449.99},
                //Проверка названия булки со значением null
                {null, 449.99},
                //Проверка булки с отрицательной ценой
                {"Булочка с кунжутом", -499.99},
                ...
                //Проверка названия булки, содержащее специальные символы
                {"***Булочка*с*кунжутом***()", 499.99}
        };
    }
