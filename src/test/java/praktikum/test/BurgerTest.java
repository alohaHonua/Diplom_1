...
public class BurgerTest {
    ...
    public void setUp() {
        ...
        ingredient1 = new Ingredient(SAUCE, HOT_SAUCE, PRICE_100f );
        ingredient2 = new Ingredient(FILLING, FILLING_CUTLET, PRICE_3000f );
        burger.setBuns(bun);
    }
    ...
    public void testSetBuns() {
        when(bun.getPrice()).thenReturn(PRICE_988f);
    ...
    public void testGetReceipt() {
        ...
        String expectedReceipt = String.format("(==== %s ====)%n" +
                        ...
                        "(==== %s ====)%n" +
                        "%nPrice: %f%n",
                bun.getName(), ingredient1.getName(),
                ingredient2.getName(),
                bun.getName(),
                burger.getPrice());
