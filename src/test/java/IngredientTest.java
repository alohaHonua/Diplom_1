...
public class IngredientTest {
    ...
    public static Object[][] testData() {
        return new Object[][]{
                {IngredientType.FILLING, "Test", 1000, new Ingredient(IngredientType.FILLING, "Test", 1000)},
                {IngredientType.FILLING, null, 1000, new Ingredient(IngredientType.FILLING, null, 1000)},
                ...
                {IngredientType.SAUCE, "Test", 1000, new Ingredient(IngredientType.SAUCE, "Test", 1000)},
                {IngredientType.SAUCE, null, 1000, new Ingredient(IngredientType.SAUCE, null, 1000)},
...
public void CreateBunTest(){
        ...
        assertTrue(Math.abs(expectIngredient.getPrice() - actualIngredient.getPrice()) < 0.001);
}
}
