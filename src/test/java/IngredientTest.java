...
public class IngredientTest {
    ...
    public static Object[][] testData() {
        return new Object[][]{
                {IngredientType.FILLING, "Test", 666, new Ingredient(IngredientType.FILLING, "Test", 666)},
                {IngredientType.FILLING, null, 666, new Ingredient(IngredientType.FILLING, null, 666)},
                ...
                {IngredientType.SAUCE, "Test", 666, new Ingredient(IngredientType.SAUCE, "Test", 666)},
                {IngredientType.SAUCE, null, 666, new Ingredient(IngredientType.SAUCE, null, 666)},
